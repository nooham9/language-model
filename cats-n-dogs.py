...
testFNames = np.random.choice(os.listdir(os.path.join(imgDir, "test")), size=20)
## add "test/" to these file names
testFNames = ["test/" + f for f in testFNames]
## replace first of these with our own images
testFNames[0] = "dandelion.jpg"
testFNames[1] = "huskies-player.jpg"
testFNames[2] = "husky-logo.jpg"
testFNames[3] = "fluffy-doggy1.jpg"
testFNames[4] = "fluffy-doggy2.jpg"
